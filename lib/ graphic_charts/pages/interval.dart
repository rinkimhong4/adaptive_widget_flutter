          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text('- A tooltip and crosshair on selection.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Double tap to clear the selection.'),
              ),
              Container(
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Uses gradient encode instead of color.'),
              ),
              Container(
                margin: const EdgeInsets.only(top: 10),
                width: 350,
              ...
              Container(
                ...
                child: Chart(
                  data: intervalData,
                  variables: {
                    'id': Variable(accessor: (Map map) => map['id'] as String),
                    'min': Variable(
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Nested by type.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(20, 40, 20, 5),
                child: const Text('Pie Chart', style: TextStyle(fontSize: 20)),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(20, 40, 20, 5),
                child: const Text('Rose Chart', style: TextStyle(fontSize: 20)),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- With corner radius and shadow elevation.'),
              ),
              Container(
                margin: const EdgeInsets.only(top: 10),
                width: 350,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(20, 40, 20, 5),
                child: const Text('Race Chart', style: TextStyle(fontSize: 20)),
              ),
              Container(
                margin: const EdgeInsets.only(top: 10),
                width: 350,
              ...
              Container(
                ...
                child: Chart(
                  data: const [
                    ...
                    {'type': 'current_prcent', 'percent': 60},
                  ],
                  variables: {
                    'type': Variable(
                      accessor: (Map map) => map['type'] as String,
