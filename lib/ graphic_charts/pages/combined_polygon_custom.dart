...
List<MarkElement> centralPieLabel(
  ...
  final valueElement = LabelElement(
    ...
    anchor: const Offset(175, 150),
    style: LabelStyle(
      textStyle: const TextStyle(fontSize: 28, color: Colors.black87),
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- With rotated and formatted labels.'),
              ),
              Container(
                ...
                child: Chart(
                  ...
                  variables: {
                    ...
                    "kCalIntake": Variable(
                      ...
                      scale: LinearScale(
                        ...
                        formatter: (value) => p_intl.NumberFormat(
                          null,
                          'en',
                        ).format(value.toInt()),
                      ),
                  ...
                  marks: [
                    ...
                    LineMark(
                      position:
                          Varset("date_information") * Varset("kCalTarget"),
                      size: SizeEncode(value: 1.5),
                      color: ColorEncode(value: const Color(0xff0050b3)),
                    ),
                  ],
                  axes: [
                    AxisGuide(
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(20, 40, 20, 5),
                child: const Text('Heatmap', style: TextStyle(fontSize: 20)),
              ),
              Container(
                margin: const EdgeInsets.only(top: 10),
                width: 350,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Tap to select one, and others will fade.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- With corner radius.'),
              ),
              Container(
                margin: const EdgeInsets.only(top: 10),
                width: 350,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- With dodge modifier.'),
              ),
              Container(
                margin: const EdgeInsets.only(top: 10),
                width: 350,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- A candlestick custom shape is provided.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
...
class DodgeSizeModifier extends Modifier {
  ...
  AttributesGroups modify(
    ...
    final invertedGroupPaddingHorizontal = coord.invertDistance(
    ...
    final size = max(
      maxWidthPerAttributes - barHorizontalPadding,
      _kMinBarSize,
    );
        ...
        groupRst.add(
          Attributes(
            ...
            position: oldPosition
                .map((point) => Offset(point.dx + accumulated + bias, point.dy))
                .toList(),
