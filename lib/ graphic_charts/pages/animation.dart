          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text('- With data entrance in y direction.'),
              ),
              Container(
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- With elastic animation curve.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Press refreash to rebuild.'),
              ),
              Container(
                margin: const EdgeInsets.only(top: 10),
                width: 350,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(20, 40, 20, 5),
                child: const Text('Morphing', style: TextStyle(fontSize: 20)),
              ),
              Container(
                margin: const EdgeInsets.only(top: 10),
                width: 350,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- With tree entrance values: x, y, alpha'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
