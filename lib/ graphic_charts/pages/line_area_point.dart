...
class _LineAreaPointPageState extends State<LineAreaPointPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(title: const Text('Line and Area Mark')),
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text('- Pre-select a point.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Dash line.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- With time scale in domain dimension.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Input data type is a custom class.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- With coordinate region background color.'),
              ),
              Container(
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(20, 40, 20, 5),
                child: const Text('Area chart', style: TextStyle(fontSize: 20)),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Line and area will break at NaN.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- A touch moving triggerd selection.'),
              ),
              Container(
                margin: const EdgeInsets.only(top: 10),
                width: 350,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Select and change color of a whole group'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Tap to toggle a multiple selecton.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Scalable coordinate ranges.'),
              ),
              Container(
                margin: const EdgeInsets.only(top: 10),
                width: 350,
                ...
                child: Chart(
                  data: scatterData,
                  variables: {
                    '0': Variable(accessor: (List datum) => datum[0] as num),
                    '1': Variable(accessor: (List datum) => datum[1] as num),
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- Pan to trigger an interval selection.'),
              ),
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
              ...
              Container(
                padding: const EdgeInsets.fromLTRB(10, 5, 10, 0),
                alignment: Alignment.centerLeft,
                child: const Text('- A red danger tag marks a position.'),
              ),
              Container(
                margin: const EdgeInsets.only(top: 10),
                width: 350,
