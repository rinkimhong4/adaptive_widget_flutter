...
class CrosshairPageState extends State<CrosshairPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(title: const Text('Crosshair')),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _SwitchPair(
                          ...
                          onChangedX: (isOn) => setState(
                            () => _showCrosshairOnVolume[0] = isOn
                                ? crosshairPaintStyle
                                : null,
                          ),
                          valueY: _showCrosshairOnVolume[1] != null,
                          onChangedY: (isOn) => setState(
                            () => _showCrosshairOnVolume[1] = isOn
                                ? crosshairPaintStyle
                                : null,
                          ),
                        ),
                        ...
                        _SwitchPair(
                          ...
                          onChangedX: (isOn) => setState(
                            () => _labelPaddingOnPrice[0] = isOn
                                ? _labelPadding
                                : 0.0,
                          ),
                          valueY: _labelPaddingOnPrice[1] != 0.0,
                          onChangedY: (isOn) => setState(
                            () => _labelPaddingOnPrice[1] = isOn
                                ? _labelPadding
                                : 0.0,
                          ),
                        ),
                        _SwitchPair(
                          ...
                          onChangedX: (isOn) => setState(
                            () => _labelPaddingOnVolume[0] = isOn
                                ? _labelPadding
                                : 0.0,
                          ),
                          valueY: _labelPaddingOnVolume[1] != 0.0,
                          onChangedY: (isOn) => setState(
                            () => _labelPaddingOnVolume[1] = isOn
                                ? _labelPadding
                                : 0.0,
                          ),
                        ),
            ...
            children: [
              ...
              Container(
                ...
                child: Chart(
                  ...
                  marks: [LineMark(size: SizeEncode(value: 1))],
                  axes: [
              ...
              Container(
                ...
                child: Chart(
                  ...
                  marks: [IntervalMark(size: SizeEncode(value: 1))],
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            _SwitchRow(text: 'on X-axis', value: valueX, onChanged: onChangedX),
            _SwitchRow(text: 'on Y-axis', value: valueY, onChanged: onChangedY),
          ],
        ),
      ],
    );
